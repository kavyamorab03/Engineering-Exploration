...
|02.|What should be the maximum weight of machine?|Approximate 2kg|Constraint|
...
|08.|Do you want the machine to be Record Each Step?|Yes|Function|
|09.|What other features are expected?|It should Hold The Object Accurately.|Function|
|10.|What other features are expected?|It should Playback the Each Recorded Steps.|Function|
